...
h3 { color: #14b8a6 !important; font-weight: 600 !important; font-size: 1.2rem !important; }
...
.stApp::before {
    ...
    background:
        radial-gradient(ellipse at 20% 80%, rgba(15, 118, 110, 0.08) 0%, transparent 50%),
...
st.sidebar.caption("[Dwi Revani Tyas        - 2560613]")
